...
<body>
	<table class="table table-bordered table-hover table-striped" border='1'>
		...
		<tr>
			<td>1</td>
			<td>
				<a href="<c:url value="/download/eziscan"/>">ì´ì§ì¤ìº ë°±ì  ìë°ì´í¸ ë¤ì´ë¡ë</a>
			</td>
			<td>	
				ë°ì´ë¬ì¤ í¨í´ ì   : ${vo.numOfDetectableVirus } / 
				ë°ì´ë¬ì¤ ìì§ ë²ì  : ${vo.dateOfVirusData}
			</td>
		</tr>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="index.html">ì ì§ë³´ì ê´ë¦¬ì ë³´</a></li>
                    <li><a href="about-us.html">ê³ ê°ì¬ì´í¸ ì ë³´</a></li>
                    <li><a href="services.html">Sì ì§ë³´ì íê²½ ì ë³´ (ìì½)</a></li>
