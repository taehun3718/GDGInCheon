...
<head>
    ...
    <title>Home | ssbridge 보안사업팀 제품소개</title>
...
<body>
    ...
    <jsp:include page="./header/productHeader.jsp" flush="false" />
			보안사업팀 제품소개
            ...
            <div class="row">
                    ...
                    <div class="media">
                     ...
                     -->
                        <div class="media-body">
                            <h3 class="media-heading">Speedly</h3>
                            <p>빠르고</p>
                        </div>
                    </div>
                </div><!--/.col-md-4-->
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <!-- 
                        ...
                        -->
                        <div class="media-body">
                            <h3 class="media-heading">Bridge</h3>
                            <p>망과 망간을 연결해주는 SSbridge 입니다.</p>
                        </div>
                    </div>
                </div><!--/.col-md-4-->
            </div>
